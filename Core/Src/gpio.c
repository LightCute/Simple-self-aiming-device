...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, BEEP_Pin|BIN1_Pin|AIN2_Pin|AIN1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : POWER_EN_Pin BEEP_Pin BIN1_Pin AIN2_Pin
                           AIN1_Pin */
  GPIO_InitStruct.Pin = POWER_EN_Pin|BEEP_Pin|BIN1_Pin|AIN2_Pin
                          |AIN1_Pin;
  ...
  /*Configure GPIO pins : PWM_EN_Pin LED_Pin */
  GPIO_InitStruct.Pin = PWM_EN_Pin|LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : RED1_Pin RED2_Pin RED3_Pin */
  GPIO_InitStruct.Pin = RED1_Pin|RED2_Pin|RED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : SensorL_Pin */
  GPIO_InitStruct.Pin = SensorL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(SensorL_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SensorR_Pin */
  GPIO_InitStruct.Pin = SensorR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(SensorR_GPIO_Port, &GPIO_InitStruct);
